...
class AdvancedContainerManager {
  ...
  private initializeServices(): void {
    ...
    this.wsHandler = new WebSocketHandler(this.io, this.metricsCollector, this.logger);
  ...
  private setupRoutes(): void {
    ...
    // API routes
    this.app.use('/api', routes(this.dockerService, this.projectService, this.terminalService, this.metricsCollector));
  ...
  public async start(): Promise<void> {
    try {
      ...
      this.server.listen(this.config.port, this.config.host, () => {
        ...
        this.logger.info(`Docker: ${this.dockerService.isConnected() ? 'Connected' : 'Disconnected'}`);
        this.logger.info(`Redis: ${this.metricsCollector.isRedisConnected() ? 'Connected' : 'Disconnected'}`);
      });
