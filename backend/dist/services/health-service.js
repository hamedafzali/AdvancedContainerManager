...
class HealthService {
    ...
    getVersion() {
        try {
            const packageJson = (0, fs_1.readFileSync)((0, path_1.join)(__dirname, "../../package.json"), "utf8");
    ...
    async checkDockerHealth() {
        ...
        try {
            ...
            (0, child_process_1.execSync)("docker info", { encoding: "utf8", timeout: 5000 });
    ...
    async checkRedisHealth() {
        ...
        try {
            ...
            (0, child_process_1.execSync)("redis-cli ping", { encoding: "utf8", timeout: 3000 });
            const responseTime = Date.now() - startTime;
            return {
                name: "redis",
                status: "healthy",
    ...
    async checkDiskSpace() {
        const startTime = Date.now();
        try {
            const stats = (0, child_process_1.execSync)("df -h /", { encoding: "utf8" });
    ...
    async checkMemoryUsage() {
        const startTime = Date.now();
        try {
            const stats = (0, child_process_1.execSync)("free -m", { encoding: "utf8" });
            const lines = stats.split("\n");
    ...
    async checkSystemLoad() {
        const startTime = Date.now();
        try {
            const loadAvg = (0, child_process_1.execSync)("cat /proc/loadavg", { encoding: "utf8" });
